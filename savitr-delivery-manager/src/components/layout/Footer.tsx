    ...
    <footer className="bg-gray-100 border-t">
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold text-red-600 mb-4">Savitr-AI Delivery Manager</h3>
            <p className="text-sm text-gray-600">
              Take control of your deliveries with advanced AI-powered logistics and tracking.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/tracking" className="text-gray-600 hover:text-red-600">
                  Track Your Package
                </Link>
              </li>
              <li>
                <Link href="/manage" className="text-gray-600 hover:text-red-600">
                  Manage Deliveries
                </Link>
              </li>
              <li>
                <Link href="/schedule" className="text-gray-600 hover:text-red-600">
                  Schedule Delivery
                </Link>
              </li>
              <li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600">
            &copy; {new Date().getFullYear()} Savitr-AI Technologies, Inc. All rights reserved.
          </p>
